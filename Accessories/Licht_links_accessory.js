...
exports.accessory = {
  displayName: "die linke Leuchte",
  username: "1A:2A:3A:4A:5A:FA",
  pincode: "031-45-154",
  services: [{
    ...
    characteristics: [{
    	...
    	perms: ["pr"],
		format: "string",
		initialValue: "linke Nachttischlampe",
		supportEvents: false,
		supportBonjour: false,
		manfDescription: "IKEA",
    ...
    characteristics: [{
    	...
    	perms: ["pr"],
		format: "string",
		initialValue: "die linke Nachttischleuchte",
		supportEvents: false,
		supportBonjour: false,
		manfDescription: "Bla",
		designedMaxLength: 255   
	...
	{ 
    		...
    		if (value) {
			PythonShell.run('links1.py', function (err) {
 				console.log('On Success');
			});
    		} else {
    			PythonShell.run('links0.py', function (err) {
